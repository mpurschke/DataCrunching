# COVID
During the Pandemic, BNL put out a call for volunteers to number-crunch a huge database of molecules to see if there are candidates for a Corons-Virus antigen. I ended up processing the bulk of the workload. I cashed in on my knowledge of large-scale condor-based processing, and got it done.
